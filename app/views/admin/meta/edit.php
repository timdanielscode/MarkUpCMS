...
<?php $this->include('openHeadTag'); ?>  
    <?php $this->title('Metas edit page'); ?>
...
<div class="row">
    <div class="col10 col10-L- col9-L col8-S">
        ...
        <?php core\Alert::message('success'); ?>
            <form id="editorForm" action="/admin/metas/<?php echo $cdn['id']; ?>/update" method="POST" class="form-code">
    ...
    <div class="col2 col2-L col3-L col4-S">
        <div id="sidebar" class="width-25">
            <div class="sidebarContainer">
                ...
                <div class="buttonContainer">
                    <form action="/admin/metas/<?php echo $cdn['id']; ?>/import-all" method="POST">
                    ...
                    <form action="/admin/metas/<?php echo $cdn['id']; ?>/export-all" method="POST">
                        <input type="submit" name="submit" value="Export all" class="button darkButton margin-t-10" onclick="return confirm('Are you sure?');"/>
                    </form>
                </div>
                <form class="cdnForm" action="/admin/metas/<?php echo $cdn['id']; ?>/export-pages" method="POST">
                ...
                <form class="cdnForm" action="/admin/metas/<?php echo $cdn['id']; ?>/import-pages" method="POST">
                    <label>Pages: </label>
                    <select name="pages[]" multiple>
