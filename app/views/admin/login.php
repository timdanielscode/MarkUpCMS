...
<div class="container my-179">
    ...
    <?php if(Session::exists("Csrf_token_message")) { ?>
        <div class="my-5 w-75 mx-auto"><?php echo Alert::display("warning", "Csrf_token_message"); ?></div>
    <?php Session::delete('Csrf_token_message'); } ?>

    <form method="POST" action="" class="d-block w-50 mx-auto">
    <h1 class="text-color-sec mb-5">Login for admins</h1>
