...
<?php $this->include('openHeadTag'); ?>  
    ...
    <?php $this->script('/assets/js/media/create/Sidebar.js', true); ?>
    <?php $this->script('/assets/js/media/create/FileContainer.js', true); ?>
    <?php $this->script('/assets/js/media/create/ReadImageContainer.js', true); ?>
    <?php $this->script('/assets/js/media/create/Ranger.js', true); ?>
    <?php $this->script('/assets/js/media/create/main.js', true); ?>
    <?php $this->script('/assets/js/ajax.js'); ?>
    <?php $this->script('/assets/js/media/create/update/filename.js'); ?>
    <?php $this->script('/assets/js/media/create/update/description.js'); ?>
...
<div class="row">
    <div class="col10 col10-L- col9-L col8-S">
        ...
        <?php if(core\Session::get('user_role') === 'admin') { ?>
            <form action="/admin/media/create/folder?<?php echo "folder=" . $folder; ?>" method="POST" class="folderForm">
                ...
                <div class="fileInfoContainer display-none">
                    ...
                    <div class="infoContainer">
                        <div class="infoPart">
                            ...
                            <div id="MESSAGE"></div>
                            <?php if(core\Session::get('user_role') === 'admin') { ?><a data-role="update" id="update" class="button greenButton margin-t-10 width-50-px">Update</a><?php } ?>
                        </div>
                        <div class="infoPart">
                        ...
                        <div class="infoPart">
                            ...
                            <?php if(core\Session::get('user_role') === 'admin') { ?><a data-role="update-description" id="updateDescription" class="button greenButton margin-t-10 width-50-px">Update</a><?php } ?>
                        </div>
                    </div>
                </div>
            </div>
